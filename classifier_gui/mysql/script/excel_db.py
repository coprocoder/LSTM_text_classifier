...
class Excel:
    ...
    @staticmethod
    def db_to_excel(classifier_object, begin_data, end_data ):
        # coding: utf-8
        ...
        conn = create_engine('mysql+pymysql://' + classifier_object.dbotrs['username'] + ':' + classifier_object.dbotrs['password'] +',M1@10.1.10.5/otrs')
    ...
    @staticmethod
    def excel_to_db(classifier_object):
        # открываем файл
